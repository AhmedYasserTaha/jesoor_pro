...
class SignupForm extends StatefulWidget {
  ...
  // Loading states from SignupCubit
  final SignupStatus getCategoriesStatus; // Loading state for parent categories
  final SignupStatus
  ...
  Widget build(BuildContext context) {
    if (widget.step == 3) {
      ...
      final isLoadingCategories =
          widget.getCategoriesStatus == SignupStatus.loading ||
          (widget.availableCategories.isEmpty &&
              widget.getCategoriesStatus == SignupStatus.loading);
      final isLoadingChildren =
          widget.getCategoryChildrenStatus == SignupStatus.loading;
